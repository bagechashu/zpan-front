...
let router = new Router({
  ...
  routes: [
    ...
    { path: '/viewer/pdf', name: 'viewer', component: () => import('@/components/Viewers/pages/PdfViewer.vue') },
    { path: '/viewer/doc', name: 'doc-viewer', component: () => import('@/components/Viewers/pages/DocViewer.vue') },
    { path: '/viewer/xlsx', name: 'xlsx-viewer', component: () => import('@/components/Viewers/pages/XlsxViewer.vue') },
    { path: '/viewer/pptx', name: 'pptx-viewer', component: () => import('@/components/Viewers/pages/PptxViewer.vue') },
    {
      path: '/settings',
